...
docker run --name headless_player_container headless_player_component scripts/dash-emulator.py  --dump-results results/result http://162.246.156.61:11000/output.mpd
